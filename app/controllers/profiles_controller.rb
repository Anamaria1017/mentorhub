...
class ProfilesController < ApplicationController
  ...
  def profile_params
    params.require(:profile).permit(:first_name, :last_name, :username, :role, :birthday, :birthday, :languages, :city, :highest_education, :edu_organization, :working_experience, :current_position, :bio, :target_industry, :preferred_language, :type_of_meeting, :proximity_preference, :mentor_skills, :photo)
  end
end
